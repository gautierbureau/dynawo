...
case_name = "IEEE14 - DumpFinalValues"
case_description = "IEEE14 - DumpFinalValues"
job_file = os.path.join(os.path.dirname(__file__), "IEEE14_SyntaxExamples", "IEEE14_DumpFinalValues", "IEEE14.jobs")
...
case_description = "IEEE14 split into two synchronous islands by tripping the three inter-area transformers (4-7, 4-9, 5-6) at t = 1 s, then merged back by reclosing them at t = 11 s; keepAllSynchronousComponents keeps both islands alive and DYNModelOmegaRef computes one barycenter per island while split"
...
case_name = "IEEE14 - Line Fault"
case_description = "IEEE14 - Line Fault"
job_file = os.path.join(os.path.dirname(__file__), "IEEE14_BasicTestCases", "IEEE14_LineFault", "IEEE14.jobs")
