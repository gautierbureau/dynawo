...
case_name = "EmtNetworkHvdc"
case_description = "EMT network exercising an HVDC link modelled as two decoupled PQ current injections (the phasor's own simplified form)."
