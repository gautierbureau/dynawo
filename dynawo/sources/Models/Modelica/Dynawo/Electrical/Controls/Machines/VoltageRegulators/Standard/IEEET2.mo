...
model IEEET2 "IEEE type 2 Exciter (IEEET2)"
  ...
  Modelica.Blocks.Continuous.Derivative derivative(T = tF1, k = Kf, x_start = Efd0Pu) annotation(
    Placement(visible = true, transformation(origin = {90, -80}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.FirstOrder firstOrder1(initType = Modelica.Blocks.Types.Init.InitialState, T = tF2, y_start = 0) annotation(
...
equation
  ...
  connect(derivative.y, firstOrder1.u) annotation(
    Line(points = {{78, -80}, {42, -80}}, color = {0, 0, 127}));
  connect(firstOrder1.y, feedback.u2) annotation(
    Line(points = {{18, -80}, {-20, -80}, {-20, -8}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Rectangle(extent = {{-138, 100}, {-138, 100}}), Text(extent = {{-100, 60}, {100, -60}}, textString = "IEEET2")}),
    Documentation(info = "<html><head></head><body>This model implements the IEEE Type 2 Exciter as shown in the&nbsp;<!--StartFragment-->I. C. Report, \"Computer representation of excitation systems,\" in <em>IEEE Transactions on Power Apparatus and Systems</em>, vol. PAS-87, no. 6, pp. 1460-1464, June 1968, doi: 10.1109/TPAS.1968.292114. It differs from the IEEE Type 1 Exciter by the excitation rate feedback, which uses two time constants instead of one.<!--EndFragment--></body></html>"));
end IEEET2;
