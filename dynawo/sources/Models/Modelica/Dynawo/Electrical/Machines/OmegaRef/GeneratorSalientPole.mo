...
model GeneratorSalientPole "Fifth-order salient-pole synchronous machine model"
  /*
    Fifth-order salient-pole synchronous machine. The d-axis keeps the field
    winding (transient EMF eqPPu) and one damper (subtransient flux psi1d);
    the salient-pole q-axis has no field winding (no q-axis transient EMF)
    and one damper (subtransient flux psi2q). Five states: rotor angle and
    speed, eqPPu, psi1d, psi2q. Corresponds to the CGMES IEC 61970-302 GenSal
    model (PSS/E GENSAL). Receptor convention; coupled to OmegaRef.
  */
