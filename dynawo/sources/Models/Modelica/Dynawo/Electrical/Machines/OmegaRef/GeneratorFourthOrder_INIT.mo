...
model GeneratorFourthOrder_INIT "Initialization model for the fourth-order synchronous machine"
...
equation
  ...
  // Transient EMFs from the steady-state stator and rotor equations
