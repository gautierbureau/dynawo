...
model GeneratorSalientPoleTypeJ_INIT "Initialization model for the GENTPJ salient-pole synchronous machine"
  ...
  Types.PerUnit psiArg0Pu "Saturation function argument at the initial operating point in pu (base UNom)";
  Types.PerUnit Sat0Pu "Saturation function value S(psiArg) at the initial operating point";
  ...
  Types.PerUnit I0Pu "Stator current magnitude in pu (base SNom)";
...
equation
  // Air-gap voltage phasor and stator current magnitude (frame independent)
  psiAg0Cpx = u0Pu - Complex(RaPu, XlPu) * i0Pu * kk;
  psiAg0Pu = ComplexMath.'abs'(psiAg0Cpx);
  I0Pu = ComplexMath.'abs'(i0Pu) * kk;
  psiArg0Pu = psiAg0Pu + KisPu * I0Pu;

  // Saturation function S(psiArg) (scaled-quadratic), and SatD / SatQ factors
  Sat0Pu = satB * (psiArg0Pu - satA) * (psiArg0Pu - satA) / psiArg0Pu;
  satD0Pu = 1 + Sat0Pu;
  ...
  // d-axis subtransient flux dynamics at SS give the transient EMF
...
end GeneratorSalientPoleTypeJ_INIT;
