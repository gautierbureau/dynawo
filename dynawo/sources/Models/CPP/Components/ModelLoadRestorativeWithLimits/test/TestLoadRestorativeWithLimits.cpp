...
TEST(ModelsLoadRestorativeWithLimits, ModelLoadRestorativeWithLimitsContinuousAndDiscreteMethods) {
  ...
  ASSERT_DOUBLE_EQUALS_DYNAWO(modelLoad->evalCalculatedVarI(1), 168.1792830507);
  ASSERT_NO_THROW(modelLoad->evalCalculatedVarI(2));
  ASSERT_DOUBLE_EQUALS_DYNAWO(modelLoad->evalCalculatedVarI(2), 2.378414230005);
  ASSERT_NO_THROW(modelLoad->evalCalculatedVarI(3));
  ASSERT_DOUBLE_EQUALS_DYNAWO(modelLoad->evalCalculatedVarI(3), 2.);
  ASSERT_NO_THROW(modelLoad->evalCalculatedVarI(4));
  ASSERT_DOUBLE_EQUALS_DYNAWO(modelLoad->evalCalculatedVarI(4), 2.);
  ASSERT_THROW_DYNAWO(modelLoad->evalCalculatedVarI(5), Error::MODELER, KeyError_t::UndefCalculatedVarI);
  ...
  ASSERT_DOUBLE_EQUALS_DYNAWO(res[0], 126.1344622881);
  ASSERT_DOUBLE_EQUALS_DYNAWO(res[1], 126.1344622881);
  ASSERT_DOUBLE_EQUALS_DYNAWO(res[2], -252.2689245761);
  ...
  ASSERT_NO_THROW(modelLoad->evalJCalculatedVarI(3, res));
  ASSERT_NO_THROW(modelLoad->evalJCalculatedVarI(4, res));
  ASSERT_THROW_DYNAWO(modelLoad->evalJCalculatedVarI(5, res), Error::MODELER, KeyError_t::UndefJCalculatedVarI);
  ...
  ASSERT_NO_THROW(modelLoad->getIndexesOfVariablesUsedForCalculatedVarI(3, indexes));
  ASSERT_NO_THROW(modelLoad->getIndexesOfVariablesUsedForCalculatedVarI(4, indexes));
  ASSERT_THROW_DYNAWO(modelLoad->getIndexesOfVariablesUsedForCalculatedVarI(5, indexes), Error::MODELER, KeyError_t::UndefJCalculatedVarI);
